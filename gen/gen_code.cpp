...
//			{ 0x9B, 0xD9, 7, "fstcw" }, // not correct order for fstcw [eax] on 64bit OS
	...
	// (x, x/m[, imm]) or (y, y/m[, imm])
	{
		const struct Tbl {
			...
			{ 0xDF, "aeskeygenassist", T_0F3A | T_66, 0, true },
			{ 0x09, "roundpd", T_0F3A | T_66 | T_SUPPORT_YMM, 0, true },
			{ 0x08, "roundps", T_0F3A | T_66 | T_SUPPORT_YMM, 0, true },
			{ 0x05, "permilpd", T_0F3A | T_66 | T_SUPPORT_YMM, 0, true },
			{ 0x04, "permilps", T_0F3A | T_66 | T_SUPPORT_YMM, 0, true },
			{ 0x61, "pcmpestri", T_0F3A | T_66, 0, true },
			{ 0x60, "pcmpestrm", T_0F3A | T_66, 0, true },
			{ 0x63, "pcmpistri", T_0F3A | T_66, 0, true },
			{ 0x62, "pcmpistrm", T_0F3A | T_66, 0, true },
			{ 0x0E, "testps", T_0F38 | T_66 | T_SUPPORT_YMM, 0, false },
			{ 0x0F, "testpd", T_0F38 | T_66 | T_SUPPORT_YMM, 0, false },
			{ 0x2F, "comisd", T_0F | T_66, -1, false },
			{ 0x2F, "comiss", T_0F, -1, false },
			{ 0x5B, "cvtdq2ps", T_0F | T_SUPPORT_YMM, -1, false },
			{ 0x5B, "cvtps2dq", T_0F | T_66 | T_SUPPORT_YMM, -1, false },
			{ 0x5B, "cvttps2dq", T_0F | T_F3 | T_SUPPORT_YMM, -1, false },
			{ 0x28, "movapd", T_0F | T_66 | T_SUPPORT_YMM, -1, false },
			{ 0x28, "movaps", T_0F | T_SUPPORT_YMM, -1, false },
			{ 0x12, "movddup", T_0F | T_F2 | T_SUPPORT_YMM, -1, false },
			{ 0x6F, "movdqa", T_0F | T_66 | T_SUPPORT_YMM, -1, false },
			{ 0x6F, "movdqu", T_0F | T_F3 | T_SUPPORT_YMM, -1, false },
			{ 0x16, "movshdup", T_0F | T_F3 | T_SUPPORT_YMM, -1, false },
			{ 0x12, "movsldup", T_0F | T_F3 | T_SUPPORT_YMM, -1, false },
			{ 0x10, "movupd", T_0F | T_66 | T_SUPPORT_YMM, -1, false },
			{ 0x10, "movups", T_0F | T_SUPPORT_YMM, -1, false },

			{ 0x1C, "pabsb", T_0F38 | T_66 | T_SUPPORT_YMM, -1, false },
			{ 0x1D, "pabsw", T_0F38 | T_66 | T_SUPPORT_YMM, -1, false },
			{ 0x1E, "pabsd", T_0F38 | T_66 | T_SUPPORT_YMM, -1, false },
			{ 0x41, "phminposuw", T_0F38 | T_66, -1, false },

			{ 0x20, "pmovsxbw", T_0F38 | T_66 | T_SUPPORT_YMM, -1, false },
			{ 0x21, "pmovsxbd", T_0F38 | T_66 | T_SUPPORT_YMM, -1, false },
			{ 0x22, "pmovsxbq", T_0F38 | T_66 | T_SUPPORT_YMM, -1, false },
			{ 0x23, "pmovsxwd", T_0F38 | T_66 | T_SUPPORT_YMM, -1, false },
			{ 0x24, "pmovsxwq", T_0F38 | T_66 | T_SUPPORT_YMM, -1, false },
			{ 0x25, "pmovsxdq", T_0F38 | T_66 | T_SUPPORT_YMM, -1, false },

			{ 0x30, "pmovzxbw", T_0F38 | T_66 | T_SUPPORT_YMM, -1, false },
			{ 0x31, "pmovzxbd", T_0F38 | T_66 | T_SUPPORT_YMM, -1, false },
			{ 0x32, "pmovzxbq", T_0F38 | T_66 | T_SUPPORT_YMM, -1, false },
			{ 0x33, "pmovzxwd", T_0F38 | T_66 | T_SUPPORT_YMM, -1, false },
			{ 0x34, "pmovzxwq", T_0F38 | T_66 | T_SUPPORT_YMM, -1, false },
			{ 0x35, "pmovzxdq", T_0F38 | T_66 | T_SUPPORT_YMM, -1, false },

			{ 0x70, "pshufd", T_0F | T_66 | T_SUPPORT_YMM, -1, true },
			{ 0x70, "pshufhw", T_0F | T_F3 | T_SUPPORT_YMM, -1, true },
			{ 0x70, "pshuflw", T_0F | T_F2 | T_SUPPORT_YMM, -1, true },

			{ 0x17, "ptest", T_0F38 | T_66, -1, false },
			{ 0x53, "rcpps", T_0F | T_SUPPORT_YMM, -1, false },
			{ 0x52, "rsqrtps", T_0F | T_SUPPORT_YMM, -1, false },

			{ 0x51, "sqrtpd", T_0F | T_66 | T_SUPPORT_YMM, -1, false },
			{ 0x51, "sqrtps", T_0F | T_SUPPORT_YMM, -1, false },

			{ 0x2E, "ucomisd", T_0F | T_66, -1, false },
			{ 0x2E, "ucomiss", T_0F, -1, false },
		};
		for (size_t i = 0; i < NUM_OF_ARRAY(tbl); i++) {
			const Tbl *p = &tbl[i];
			std::string type = type2String(p->type);
	...
	// vmov(h|l)(pd|ps)
	{
		...
		for (size_t i = 0; i < NUM_OF_ARRAY(tbl); i++) {
			...
			const char *type = p.isPd ? "T_0F | T_66" : "T_0F";
	...
	// FMA others
	{
		...
		printf("void vpextrb(const Operand& op, const Xmm& x, uint8 imm) { if (!op.isREG(i32e) && !op.isMEM()) throw Error(ERR_BAD_COMBINATION); opAVX_X_X_XMcvt(x, xm0, op, !op.isMEM(), Operand::XMM, T_0F3A | T_66, 0x14, imm); }\n");
		printf("void vpextrw(const Reg& r, const Xmm& x, uint8 imm) { opAVX_X_X_XM(Xmm(r.getIdx()), xm0, x, T_0F | T_66, 0xC5, imm); }\n");
		printf("void vpextrw(const Address& addr, const Xmm& x, uint8 imm) { opAVX_X_X_XM(x, xm0, addr, T_0F3A | T_66, 0x15, imm); }\n");
		printf("void vpextrd(const Operand& op, const Xmm& x, uint8 imm) { if (!op.isREG(32) && !op.isMEM()) throw Error(ERR_BAD_COMBINATION); opAVX_X_X_XMcvt(x, xm0, op, !op.isMEM(), Operand::XMM, T_0F3A | T_66 | T_W0, 0x16, imm); }\n");

		printf("void vpinsrb(const Xmm& x1, const Xmm& x2, const Operand& op, uint8 imm) { if (!op.isREG(32) && !op.isMEM()) throw Error(ERR_BAD_COMBINATION); opAVX_X_X_XMcvt(x1, x2, op, !op.isMEM(), Operand::XMM, T_0F3A | T_66, 0x20, imm); }\n");
		printf("void vpinsrb(const Xmm& x, const Operand& op, uint8 imm) { if (!op.isREG(32) && !op.isMEM()) throw Error(ERR_BAD_COMBINATION); opAVX_X_X_XMcvt(x, x, op, !op.isMEM(), Operand::XMM, T_0F3A | T_66, 0x20, imm); }\n");

		printf("void vpinsrw(const Xmm& x1, const Xmm& x2, const Operand& op, uint8 imm) { if (!op.isREG(32) && !op.isMEM()) throw Error(ERR_BAD_COMBINATION); opAVX_X_X_XMcvt(x1, x2, op, !op.isMEM(), Operand::XMM, T_0F | T_66, 0xC4, imm); }\n");
		printf("void vpinsrw(const Xmm& x, const Operand& op, uint8 imm) { if (!op.isREG(32) && !op.isMEM()) throw Error(ERR_BAD_COMBINATION); opAVX_X_X_XMcvt(x, x, op, !op.isMEM(), Operand::XMM, T_0F | T_66, 0xC4, imm); }\n");
	...
	// mov
	{
		printf("void vmovd(const Xmm& x, const Reg32& reg) { opAVX_X_X_XM(x, xm0, Xmm(reg.getIdx()), T_0F | T_66 | T_W0, 0x6E); }\n");
		printf("void vmovd(const Xmm& x, const Address& addr) { opAVX_X_X_XM(x, xm0, addr, T_0F | T_66 | T_W0, 0x6E); }\n");
		printf("void vmovd(const Reg32& reg, const Xmm& x) { opAVX_X_X_XM(x, xm0, Xmm(reg.getIdx()), T_0F | T_66 | T_W0, 0x7E); }\n");
		printf("void vmovd(const Address& addr, const Xmm& x) { opAVX_X_X_XM(x, xm0, addr, T_0F | T_66 | T_W0, 0x7E); }\n");

		printf("void vmovq(const Xmm& x, const Address& addr) { opAVX_X_X_XM(x, xm0, addr, T_0F | T_F3, 0x7E); }\n");
		printf("void vmovq(const Address& addr, const Xmm& x) { opAVX_X_X_XM(x, xm0, addr, T_0F | T_66, 0xD6); }\n");
		printf("void vmovq(const Xmm& x1, const Xmm& x2) { opAVX_X_X_XM(x1, xm0, x2, T_0F | T_F3, 0x7E); }\n");
	...
	// x64
	{
		...
		printf("#ifdef XBYAK64\n");
		printf("void vmovq(const Xmm& x, const Reg64& reg) { opAVX_X_X_XM(x, xm0, Xmm(reg.getIdx()), T_0F | T_66 | T_W1, 0x6E); }\n");
		printf("void vmovq(const Reg64& reg, const Xmm& x) { opAVX_X_X_XM(x, xm0, Xmm(reg.getIdx()), T_0F | T_66 | T_W1, 0x7E); }\n");

		printf("void vpextrq(const Operand& op, const Xmm& x, uint8 imm) { if (!op.isREG(64) && !op.isMEM()) throw Error(ERR_BAD_COMBINATION); opAVX_X_X_XMcvt(x, xm0, op, !op.isMEM(), Operand::XMM, T_0F3A | T_66 | T_W1, 0x16, imm); }\n");

		printf("void vpinsrq(const Xmm& x1, const Xmm& x2, const Operand& op, uint8 imm) { if (!op.isREG(64) && !op.isMEM()) throw Error(ERR_BAD_COMBINATION); opAVX_X_X_XMcvt(x1, x2, op, !op.isMEM(), Operand::XMM, T_0F3A | T_66 | T_W1, 0x22, imm); }\n");
		printf("void vpinsrq(const Xmm& x, const Operand& op, uint8 imm) { if (!op.isREG(64) && !op.isMEM()) throw Error(ERR_BAD_COMBINATION); opAVX_X_X_XMcvt(x, x, op, !op.isMEM(), Operand::XMM, T_0F3A | T_66 | T_W1, 0x22, imm); }\n");
