...
void putAMX_rev54()
{
	...
	puts("void tdpbf8ps(const Tmm& x1, const Tmm& x2, const Tmm& x3) { opVex(x1, &x3, x2, T_FP8|T_W0, 0xFD); }");
	puts("void tdpbhf8ps(const Tmm& x1, const Tmm& x2, const Tmm& x3) { opVex(x1, &x3, x2, T_F2|T_FP8|T_W0, 0xFD); }");
	puts("void tdphbf8ps(const Tmm& x1, const Tmm& x2, const Tmm& x3) { opVex(x1, &x3, x2, T_F3|T_FP8|T_W0, 0xFD); }");
	puts("void tdphf8ps(const Tmm& x1, const Tmm& x2, const Tmm& x3) { opVex(x1, &x3, x2, T_66|T_FP8|T_W0, 0xFD); }");
