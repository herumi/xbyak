...
- `r30`, `r31` : explicitly available by specifying `UseR30R31` in `tNum`. These APX registers are considered callee-saved, so StackFrame always pushes/pops them when reserved.
